...
This project uses a custom license that allows free personal and academic use but requires negotiation for commercial applications - see the [LICENSE](LICENSE) file for details.
